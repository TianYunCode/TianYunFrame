...
class T_FlatUITest : public QWidget
{
    Q_OBJECT
public:
    explicit T_FlatUITest(QWidget *parent = nullptr) : QWidget(parent)
    {
        // 初始化主界面
        this->setWindowFlags(Qt::FramelessWindowHint | Qt::WindowStaysOnTopHint);
        this->setAttribute(Qt::WA_StyledBackground);
        this->setFixedSize(1080, 720);
        this->setObjectName("FlatUI");
        ...
        pLayoutEdit->setContentsMargins(0,0,0,0);
        ...
        pLayoutCheckBox->setContentsMargins(0,0,0,0);
        ...
        pLayoutRadioBtn->setContentsMargins(0,0,0,0);
        ...
        pLayoutSlider->setContentsMargins(0,0,0,0);
