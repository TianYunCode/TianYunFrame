...
#else
#define REST_LOG_ERROR rest_rpc::cerr_logger_t {}
#endif

#ifdef REST_LOG_WARNING
#else
#ifndef NDEBUG
#define REST_LOG_WARNING rest_rpc::cerr_logger_t {}
#else
...
#else
#ifndef NDEBUG
#define REST_LOG_INFO rest_rpc::cout_logger_t {}
#else
...
#else
#ifndef NDEBUG
#define REST_LOG_DEBUG rest_rpc::cout_logger_t {}
#else
...
#else
#ifndef NDEBUG
#define REST_LOG_TRACE rest_rpc::cout_logger_t {}
#else
